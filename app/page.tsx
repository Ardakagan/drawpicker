...
const HOME_TEXT: Record<string, any> = {
  ...
  fr: {
    account: "👤 Compte", youtubeTitle: "Tirage YouTube", youtubeSub: "Choisissez un gagnant équitable parmi les commentaires YouTube.", twitterTitle: "Tirage X (Twitter)", twitterSub: "Choisissez un gagnant équitable depuis vos publications X.", commentFiltering: "Filtrage des commentaires", multipleWinners: "Plusieurs gagnants", backupWinners: "Gagnants suppléants", certificate: "Certificat de preuve", startYoutube: "Créer un tirage YouTube →", startTwitter: "Créer un tirage X →", pricingSub: "Choisissez le plan adapté. Annulez à tout moment.", monthly: "Mensuel", yearly: "Annuel", discount: "Économisez jusqu’à 50%", freeDesc: "Essai unique", startFree: "Commencer Gratuitement →", buy: "Acheter →", details: "Voir tous les plans →", popular: "LE PLUS POPULAIRE", perMonth: "mois", perYear: "an", save: "économisé", footer: "©️ 2025 DrawPicker.io — Paiement sécurisé · Dodo Payments", footerPricing: "Prix", footerAccount: "Compte", footerLogin: "Connexion",
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetch("/api/last-draw").then((r) => r.json()).then((d) => { if (d?.lastDraw) setLastDraw(d.lastDraw); }).catch(() => {});
  }, []);
