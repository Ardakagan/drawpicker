...
export async function POST(req: Request) {
  try {
    ...
    console.log(
      `[CEKILIS] platform=${platform} taranan=${total} uygun=${eligible} sure=${scanSeconds}s kismi=${truncated} limitDoldu=${participantLimitReached} kalanHak=${remainingParticipants} aylikLimit=${plan.maxParticipants} plan=${userPlanKey} limitDoldu=${participantLimitReached} kalanHak=${remainingParticipants} aylikLimit=${plan.maxParticipants} plan=${userPlanKey}`
    );
