...
export default function ResultPage() {
  ...
  function handleShareOnX() {
    ...
    shareTextParts.push("", `🔗 ${rt.xShareVerification}`, window.location.href);
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 flex-1">
          ...
          <div className="rounded-3xl p-4 sm:p-6 flex flex-col gap-4" style={cardStyle}>
            ...
            <div className="grid gap-3">
              <button onClick={handleCopyAndShareVerificationLink} className={`${btnBase} bg-gradient-to-r from-sky-600 to-sky-500 hover:opacity-90 text-white shadow-lg shadow-sky-500/20`}>
                {copied ? `✅ ${rt.copied}` : rt.copyAndShareVerification}
              </button>
